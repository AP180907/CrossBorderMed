...
import { VerificationModal } from "@/components/verify/verification-modal";
import appCss from "../styles.css?url";

const APP_NAME = "CrossBorderMed";
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Medication, international travel, and border compliance — dataset-backed guidance before you fly.",
      },
